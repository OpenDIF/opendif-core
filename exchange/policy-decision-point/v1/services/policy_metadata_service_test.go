...
// NOTE: These tests use real database connections because they test complex database
// operations, transactions, and GORM behavior that is difficult to mock accurately.
// For unit tests that don't require real database behavior, use mocks from
// github.com/gov-dx-sandbox/exchange/shared/testutils instead.
//
